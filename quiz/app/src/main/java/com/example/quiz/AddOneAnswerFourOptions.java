        ...
        binding.buttonFirst.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (qt == "Prioritize")
                        if((Integer.parseInt(binding.answer1.getText().toString()) > 0 && Integer.parseInt(binding.answer1.getText().toString()) <5) &&
                                (Integer.parseInt(binding.answer2.getText().toString()) > 0 && Integer.parseInt(binding.answer2.getText().toString()) <5) &&
                                (Integer.parseInt(binding.answer3.getText().toString()) > 0 && Integer.parseInt(binding.answer3.getText().toString()) <5) &&
                                (Integer.parseInt(binding.answer4.getText().toString()) > 0 && Integer.parseInt(binding.answer4.getText().toString()) <5) &&
                            ...
                            Toast.makeText(getActivity(), "Only one answer should be correct and answers should be between 1 and 4 and should be unique", Toast.LENGTH_SHORT).show();
